...
public class NL2TelemetryClient
{
   ...
   */
  private static final int N_MSG_GET_STATION_STATE = 14;
   ...
   *    int32 (station index)
   */
  private static final int N_MSG_DISPATCH = 17;
   ...
   *    uchar8 (1 = on, 0 = off)
   */ 
  private static final int N_MSG_SET_GATES = 18;
   ...
   *    uchar8 (1 = on, 0 = off)
   */
  private static final int N_MSG_SET_HARNESS = 19;
   ...
   *    uchar8 (1 = on, 0 = off)
   */
  private static final int N_MSG_SET_PLATFORM = 20;
   ...
   *    uchar8 (1 = on, 0 = off)
   */
  private static final int N_MSG_SET_FLYER_CAR = 21;
   ...
   */
  private static final int N_MSG_LOAD_PARK = 24;
   ...
   * DataSize = 0
   */
  private static final int N_MSG_CLOSE_PARK = 25;  
   ...
   * DataSize = 0
   */
  private static final int N_MSG_QUIT_SERVER = 26;  
   ...
   */
  private static final int N_MSG_SET_PAUSE = 27;  
   ...
   */   
  private static final int N_MSG_RESET_PARK = 28;
   ...
   *    int32 (seat index)
   */   
  private static final int N_MSG_SELECT_SEAT = 29;  
   ...
   */
  private static final int N_MSG_SET_ATTRACTION_MODE = 30;   
   ...
   * DataSize = 0
   */
  private static final int N_MSG_RECENTER_VR = 31;  
   ...
   */  
  private static void encodeBoolean(byte[] msg, int offset, boolean b)
  {
   ...
   */  
  private static boolean decodeBoolean(byte[] msg, int offset)
  {
    return msg[offset] != 0; 
  }
  ...
  {
    return Float.intBitsToFloat(decodeInt32(msg, offset)); 
  }
  ...
  private static String decodeString(byte[] msg, int offset, int len)
  {
    ...
    try
    {
      str = new String(msg, offset, len, "UTF-8");
    }
  ...
  private static byte[] createBoolMessage(int requestId, int msgEnum, boolean bVal)
  {
  ...
  private static byte[] decodeCommand(String in)
  {
    ...
    else if (in.equals("loadpark"))
    {
      ...
      //String path = "/D:/Documents/GitHub/MDXeMotionV2/CoasterParks/MdxLogoCoaster/MdxLogoCoaster.nl2park";
      String path = "MDXeMotionV2/CoasterParks/Wilderness Park/Wilderness Park.nl2park";
  ...
  private static void printValidCommands()
  {
    ...
    System.out.println("                loadpark - Load a park in default start mode (file path is hardcoded, see sourcecode)");    
    System.out.println("                loadparkpaused - Load a park in paused start mode (file path is hardcoded, see sourcecode)");    
    System.out.println("                closepark - Closes current park");    
    System.out.println("                resetpark - Restarts current park in paused mode");
    System.out.println("                changeseat - Selects the second seat (seat index is hardcoded, see sourcecode");
    System.out.println("                pause - Activates pause");
    System.out.println("                unpause - Deactivates pause");
    System.out.println("                quitserver - Request the server to quit");
    System.out.println("                attractionmode - Enables attraction mode");
    System.out.println("                recentervr - Recenter VR");
  }
      ...
      if (size+10 == len)
      {
        ...
        case N_MSG_STATION_STATE:
          if (size == 4)
          {
            ...
            boolean bTrainInStation = (nState & (1<<11)) != 0;
            boolean bTrainInStationIsCurrentTrain = (nState & (1<<12)) != 0;
            ...
            System.out.println("    Train in Station: " + bTrainInStation);
            System.out.println("    Train in Station is Current Train: " + bTrainInStationIsCurrentTrain);
          }
          break;
        default:
